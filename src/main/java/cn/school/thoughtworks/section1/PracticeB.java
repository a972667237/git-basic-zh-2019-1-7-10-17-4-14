...
public class PracticeB {
    ...
    List<String> collectSameElements(List<String> collection1, List<List<String>> collection2) {
        ...
        Iterator<List<String>> collection_setter_list_iter;
        collection_setter_list_iter = collection2.iterator();
        collection_filter_iter = collection1.iterator();

        // start iter bigger
        while(collection_setter_list_iter.hasNext()) {
            collection_setter_iter = collection_setter_list_iter.next().iterator();
